...
class MarkovMachineGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("MarkovCalculate")
    ...
    def create_widgets(self):
        ...
        ttk.Label(main_frame, text="Входное слово:").grid(row=0, column=0, sticky=tk.W, pady=5)
        self.word_entry = ttk.Entry(main_frame, width=50)
        self.word_entry.grid(row=0, column=1, columnspan=2, sticky=(tk.W, tk.E), pady=5)
        
        ttk.Label(main_frame, text="Правила подстановки:").grid(row=1, column=0, sticky=tk.W, pady=5)
        
        rules_frame = ttk.Frame(main_frame)
        rules_frame.grid(row=2, column=0, columnspan=3, sticky=(tk.W, tk.E, tk.N, tk.S), pady=5)
        ...
        execute_frame.grid(row=5, column=0, columnspan=3, pady=10)
        ...
        ttk.Label(main_frame, text="Результат:").grid(row=6, column=0, sticky=tk.W, pady=5)
